...
-- http://stackoverflow.com/questions/13439902/function-which-takes-a-binary-tree-and-prints-out-its-values-in-order
...
{-- pretty tree print functions --}
toTree :: BinTree ([Char], [Char]) -> T.Tree [Char]
toTree Nil = T.Node "-" []
toTree (B (k,v) t1 t2) = T.Node (k ++ ":" ++ v) [toTree t1,toTree t2]
